...
import useStyles from 'modules/Admin/components/Campaign/Drawer/ViewPoll/styled.viewPoll';

function PollViewAgent() {
  const classes = useStyles();
  const [state] = useDrawer();

  return (
    <Drawer
      drawerName="pollViewAgent"
    ...
    >
      <Box className={classes.topInfo}>
        <Grid container spacing={4}>
          ...
          <Grid item>
            <Typography variant="h3">{state?.data?.fullname}</Typography>
